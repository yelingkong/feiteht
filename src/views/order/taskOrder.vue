  ...
  <div class="userContainer">
    <div class="option">
      <el-form :inline="true">
        ...
        <el-form-item  label="状态">
           <el-select v-model="ordersStatus">
    ...
    <el-table :data="List" border style="width: 100%">
      ...
      <el-table-column prop="ordersStatus" label="订单状态">
          <template slot-scope="scope">
                <el-tag type="warning" >{{scope.row.ordersStatus |showStatus}}</el-tag>
          </template>
      </el-table-column>
    </el-table>
    <div class="paginat" >
  ...
  methods: {
    ...
    getList() {
      ...
      let params = {
        ...
        ordersStatus :this.ordersStatus,//(integer, optional): 订单状态(0:竞标中/1:平台托管/2:付首款/3:进行中/4已结束/5已取消/6仲裁中) ,
