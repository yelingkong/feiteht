<template>
  <div class="userContainer">
    ...
    <el-table :data="List" border style="width: 100%">
      ...
      <el-table-column prop="userCode" label="ID">
      </el-table-column>
    
      <el-table-column prop="no" label="订单号">
      </el-table-column>
      <el-table-column prop="money" label="付款金额(元)">
      </el-table-column>
      <el-table-column prop="sum" label="总金额(元)">
      </el-table-column>
      ...
      <el-table-column prop="jf" label="抵扣积分">
      </el-table-column>
    </el-table>
    <div class="paginat" >
      <el-pagination
