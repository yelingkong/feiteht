...
<script>
    ...
    import {basefile} from "./config/env";
    ...
    export default {
        ...
        methods: {
            ...
            editMyProfile() {
                ...
                if (userInfo) {
                    var data = {
                        avatar: userInfo ? basefile + JSON.parse(userInfo).pic : '',
                        nick: userInfo ? JSON.parse(userInfo).nickName : '',
                        gender: ''
                    }
                    const options = {}
                    // 过滤空串
            ...
            getto() {
                if (this.$route.query.userId) {
                    this.handleConfirm(this.$route.query.userId)
                }
            },
