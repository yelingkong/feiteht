    ...
    <div>
        <div class="changephone">
            <el-form ref="form" :model="form" label-width="120px">
                <el-form-item :label="$t('safety.phone')">
                    <el-input class="w300" :placeholder="$t('safety.phone2')" v-model="data.phone"></el-input>
                </el-form-item>
                ...
                <el-form-item :label="$t('safety.newphone')">
                    <el-input class="w300" :placeholder="$t('safety.newphone2')" v-model="data.newphone"></el-input>
                </el-form-item>
                <el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            sendcode() {
                ...
                usersend({type: this.data.type, name: this.data.phone}).then(res => {
                    if (res.code == 200) {
                        this.getcodedjs();
                        this.$message({
                            message: res.message,
